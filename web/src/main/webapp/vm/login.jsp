...
<head>
	...
	<object classid="clsid:707C7D52-85A8-4584-8954-573EFCE77488" id="JITDSignOcx" width="0" codebase="./JITDSign.cab#version=2,0,24,19" style="height:0px;"></object>
</head>
					...
					<input type="hidden" id="original_jsp" name="original_jsp" />
	   	   	   		...
	   	   	   		<div class="landcont">
	   	   	   			...
	   	   	   			<div class="land_div" id="checkCode">
	   	   	   				...
	   	   	   				<input type="text" name="" id="code_input" class="code varify-input-code" value="" placeholder="请输入验证码"/>
	   	   	   			</div>
	   	   	   		...
	   	   	   		<div class="landcont" hidden="hidden" style="display:none">
	   	   	   			...
	   	   	   			<div class="land_sub"><input type="button" id="" name="" value="数字证书登录" style="width:284px; margin-left:18px;" onClick="pki_login()"/></div>
                        <div class="xsland_div" style="height:52px;"></div>
	   	   	   		</div>
					</form>
	   	   	   	</div>
